    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <form action=" <?= base_url('Payment/checkout'); ?>" method="post" name="myForm" onsubmit="return validateForm()">
                    <div class=" row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <?php $name = $this->db->get_where('tb_user', ['username' => $this->session->userdata('username')])->row()->nama;
                                        ?>
                                        <input type="" name="nama" value="<?= $name; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="checkout__input">
